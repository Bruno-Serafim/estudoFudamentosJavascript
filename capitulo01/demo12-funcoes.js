// function nodeDaFuncao(parametro1){
//     //bloco de código
// }
...
funcionario2.salarioLiquido = calcularDesconto(
    ...
    console.log(`
        Salario ${funcionario1.nome} ${funcionario1.salarioLiquido.toFixed(2)}
        Salario ${funcionario2.nome}: ${funcionario2.salarioLiquido.toFixed(2)}
    `)